...
import { messageServiceForAgent } from '../server/messages/message.service.js';
import { MessageStore } from '../server/storage/schema/message.store.js';
import type { AgentMessageRecord } from '../shared/messages.js';
import { withToolActivity } from '../server/tools/tool-context.js';
